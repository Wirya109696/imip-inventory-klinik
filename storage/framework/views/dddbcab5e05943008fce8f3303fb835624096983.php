    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input class="form-control form-control-sm" type="text" name="kar_jabatan[]" id="kar_jabatan" readonly
                value="<?php echo e(old('kar_nama', $dataTransaksi->karyawan->kar_jabatan)); ?>">
            ...
            <div class="col">
                <div class="form-group">
                    <input class="form-control form-control-sm" type="text" name="gudang_id[id]"
                        value="<?php echo e(old('gudang_id.' . $index, $details->gudang->penyimpanan->pen_nama)); ?>" readonly>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <input class="form-control form-control-sm" type="text" name="gudang_id[id]"
                        value="<?php echo e(old('gudang_id.' . $index, $details->gudang->gud_nama)); ?>" readonly>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="form-group">
                    <input class="form-control form-control-sm input-jumlah green-border"
                        ...
                        name="dtl_jumlah[]" value="<?php echo e(old('dtl_jumlah.' . $index, abs($details->dtl_jumlah))); ?>">
                </div>
            </div>
        </div>
    </div>
...
<div class="col-12">
    <div class="row mt-3">
        ...
        <input class="form-control form-control-sm" type="hidden" id="karyawanss" value="<?php echo e($karyawanss); ?>"
            readonly>
    </div>
</div>
...
<div class="row align-content-center">
    <div class="col-lg">
        <div class="form-group">
            ...
            <textarea class="form-control form-control-sm" type="text" id="trx_ket"><?php echo e(old('trx_ket', $dataTransaksi->trx_ket)); ?></textarea>
        </div>
    </div>
</div>
<script>
...
<?php /**PATH C:\xampp\htdocs\gudang-klinik\resources\views/barangkeluar/edit.blade.php ENDPATH**/ ?>