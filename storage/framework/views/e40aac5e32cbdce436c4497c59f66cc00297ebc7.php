...
<div class="row">
    <div class="col-lg">
        ...
        <div class="form-group">
            ...
            <button id="sbmit_btn" class="btn btn-outline-success btn-sm form-control form-control-sm"><i class="bi bi-file-earmark-plus"></i> Submit</button>
            <button id="delet_btn" class="btn btn-outline-success btn-sm form-control form-control-sm"><i class="bi bi-file-earmark-plus"></i> Delete</button> <hr>
...
<?php /**PATH C:\xampp\htdocs\inventory-test\resources\views/karyawan/add.blade.php ENDPATH**/ ?>