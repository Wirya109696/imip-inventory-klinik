    ...
    <div class="col-lg">
        <div class="form-group">
            ...
            <textarea class="form-control form-control-sm" type="text" id="trx_ket"
                placeholder="Keterangan barang masuk..."><?php echo e(old('trx_ket', $dataTransaksi->trx_ket)); ?></textarea>
        </div>
    </div>
</div>
<script>
...
<?php /**PATH C:\xampp\htdocs\gudang-klinik\resources\views/barangmasuk/edit.blade.php ENDPATH**/ ?>