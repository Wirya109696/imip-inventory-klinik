...
<input class="form-control" type="hidden" id="username_old" value="<?php echo e($data->username); ?>"><?php /**PATH C:\xampp\htdocs\gudang-klinik\resources\views/user/edit.blade.php ENDPATH**/ ?>