<div class="row">
    <div class="col-lg">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-sm" type="text" id="guard_name">
        </div>
        <div class="form-group">
...
</div><?php /**PATH C:\xampp\htdocs\inventory-imip-klinik\resources\views/role/add.blade.php ENDPATH**/ ?>