      ...
      <ul class="menu-inner py-1">
          ...
          <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(isset($menu['children']) and $menu['child'] == 'Y'): ?>
                  <li
                      class="menu-item <?php echo e(Request::is(strtolower(str_replace(' ', '', $menu['menu'])) . '*') ? 'active open' : ''); ?> ">
                      ...
                      <ul
                          class="menu-sub <?php echo e(Request::is(strtolower(str_replace(' ', '', $menu['menu'])) . '*') ? 'display: block;' : ''); ?>">
                          <?php $__currentLoopData = $menu['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li
                                  class="menu-item <?php echo e(Request::is(strtolower(str_replace(' ', '', $menu['menu'])) . '/' . strtolower($child['menu'])) ? 'active' : ''); ?> ">
              ...
              <?php else: ?>
                  <li
                      class="menu-item <?php echo e(Request::is(strtolower(str_replace(' ', '', $menu['menu']))) ? 'active' : ''); ?>">
  ...
  <!-- / Menu -->
<?php /**PATH C:\xampp\htdocs\inventory-imip-klinik\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>